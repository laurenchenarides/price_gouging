...
\begin{table}[htbp]
   \caption{\label{tab:uniformity_wholesale_crossstate} Within-chain wholesale cost uniformity: mixed-status effect net of cross-state geography}
   \centering
   \begin{tabular}{lccc}
      ...
      \midrule
      \emph{Variables}\\
      During SOE (both stores)            & -0.007$^{*}$ & -0.007$^{*}$ & 0.010$^{**}$\\   
                                          & (0.003)      & (0.003)      & (0.004)\\   
      Post-SOE (both stores)              & -0.006       & -0.006       & 0.015$^{**}$\\   
                                          & (0.004)      & (0.004)      & (0.005)\\   
      Mixed status (one during, one post) & 0.001        & -0.003       & 0.020$^{***}$\\   
                                          & (0.004)      & (0.005)      & (0.005)\\   
      Cross-state pair (geography)        &              & 0.009$^{**}$ & 0.008$^{**}$\\   
                                          &              & (0.003)      & (0.003)\\   
      \midrule
      \emph{Fixed-effects}\\
